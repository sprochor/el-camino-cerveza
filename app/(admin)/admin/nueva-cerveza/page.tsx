...
export default function NuevaCervezaAdmin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!nombre || !cerveceriaId || !estiloId) {
      setMensaje({
        tipo: "error",
        texto: "El nombre, la cervecería y el estilo son obligatorios.",
      });
      return;
    }
    ...
    try {
      ...
      setMensaje({
        tipo: "exito",
        texto: "¡Cerveza agregada al barril con éxito! 🍻",
      });

      setNombre("");
      setCerveceriaId("");
      setEstiloId("");
      setDisponibilidad("Todo el año");
      setAbv("");
      setIbu("");
      setSrm("");
      setTemperatura("");
  ...
  if (cargandoDatos) {
    return (
      <div className="p-10 text-center font-bold text-stone-500 animate-pulse">
        Cargando catálogo... 🍻
      </div>
    );
  }
    ...
    <div className="bg-stone-50 min-h-screen py-10">
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-stone-500 mt-1">
              Completá la ficha técnica para sumar una nueva etiqueta al
              ranking.
            </p>
          </div>
          <Link
        ...
        <form
          ...
          className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 space-y-8"
        >
          {mensaje.texto && (
            <div
              className={`p-4 rounded-xl font-bold text-center ${mensaje.tipo === "error" ? "bg-red-50 text-red-800" : "bg-green-50 text-green-800"}`}
            >
              {mensaje.texto}
            </div>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="lg:col-span-2">
                ...
                <input
                  ...
                  required
                  placeholder="Ej: Upside Down Stout..."
              ...
              <div>
                ...
                <select
                  value={cerveceriaId}
                  onChange={(e) => setCerveceriaId(e.target.value)}
                  required
                  className="w-full p-3 bg-stone-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none"
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-6">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <select
                  value={vasoId}
                  onChange={(e) => setVasoId(e.target.value)}
                  className="w-full p-3 bg-stone-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none"
                >
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <select
                  ...
                  className="w-full p-3 bg-stone-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none font-bold text-amber-700"
                >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Medalla de Oro - Copa Cervezas de América 2025"
                  className="w-full p-3 bg-stone-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none font-medium text-amber-900"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-600 mb-2">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full p-3 bg-stone-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none resize-none"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-600 mb-2">
                ...
                <textarea
                  value={notasCata}
                  onChange={(e) => setNotasCata(e.target.value)}
                  rows={2}
                  className="w-full p-3 bg-stone-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none resize-none"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-600 mb-2">
                  Historia de la Cerveza (Opcional)
                </label>
                <textarea
                  value={historia}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 border-t border-gray-100 pt-6">
            ...
            <button
              type="submit"
              disabled={guardando}
              className="w-full md:w-auto bg-stone-900 hover:bg-stone-800 text-amber-400 font-bold px-10 py-4 rounded-xl transition shadow-md disabled:opacity-50"
            >
